        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="bg-gray-800 rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
            ...
            <ul className="mb-8 space-y-4 text-gray-400">
              <li className="flex items-center">
                ...
                <span>Pay Once for a half hour Appointment</span>
              </li>
              <li className="flex items-center">
                <svg
                  className="h-6 w-6 text-green-500 mr-2"
                ...
                <span>half hour Appointment</span>
              </li>
            </ul>
            <a
          ...
          <div className="bg-gray-800 rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
            <div className="mb-8">
              ...
              <p className="mt-4 text-gray-400">
                Up to 5 video appointments per 30 day billing period
              </p>
            </div>
            <div className="mb-8">
            ...
            <ul className="mb-8 space-y-4 text-gray-400">
              <li className="flex items-center">
                ...
                <span>Up to five half-hour</span>
              </li>
              <li className="flex items-center">
                <svg
                  className="h-6 w-6 text-green-500 mr-2"
          ...
          <div className="bg-gray-800 rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
            <div className="mb-8">
              <h3 className="text-2xl font-semibold text-white">Quarter</h3>
              <p className="mt-4 text-gray-400">
                Up to 5 video appointments per 30 day billing period
              </p>
            </div>
          ...
          <div className="bg-gray-800 rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
            <div className="mb-8">
              <h3 className="text-2xl font-semibold text-white">Semiannual</h3>
              <p className="mt-4 text-gray-400">
                Up to 5 video appointments per 30 day billing period
              </p>
            </div>
