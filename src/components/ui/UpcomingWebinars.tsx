...
function UpcomingWebinars() {
  return (
    <div className="bg-black px-4 sm:px-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-black p-10 pt-28">
        <div className="block rounded-xl border border-gray-800 p-4 bg-black">
          ...
          <p className="sm:mt-1 block text-sm sm:text-base text-gray-300 ">
            {" "}
            Licensing of custom AI solutions tailored to meet specific business
        ...
        <div className="block rounded-xl border border-gray-800 p-4 bg-black">
          ...
          <p className="sm:mt-1 block text-sm sm:text-base text-gray-300">
            {" "}
            Expert advice on leveraging AI technologies to drive business growth
            and innovation.
          </p>
        </div>
        <div className="block rounded-xl border border-gray-800 p-4 bg-black">
          ...
          <h2 className="mt-2 font-semibold text-base sm:text-lg text-white">
            PyTorch Large Language Models Development{" "}
          </h2>
          <p className="sm:mt-1 block text-sm sm:text-base text-gray-300">
            {" "}
            Development of custom PyTorch Large Language Models for advanced AI
            applications.
          </p>
        </div>
        <div className="block rounded-xl border border-gray-800 p-4 bg-black">
