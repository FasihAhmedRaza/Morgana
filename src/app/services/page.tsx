...
const Pricing = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col justify-between h-full transform hover:scale-105 transition duration-300">
  <div>
    <div className="mb-8">
    ...
    <ul className="mb-8 space-y-4 text-gray-400">
      <li className="flex items-center mt-10">
        ...
        <span>
          Pay Once for a One Time Appointment
        </span>
      </li>
