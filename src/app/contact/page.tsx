...
function MusicSchoolContactUs() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    console.log('Submitted:', { name, organization, address, city, state, country, email, message });
    ...
    <div className="min-h-screen bg-black dark:bg-black py-12 pt-5 relative">
      ...
      <div className="max-w-2xl mx-auto p-4  mt-50 relative z-10">
        ...
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center">
          We&apos;re here to help with any questions about our Services. Reach out and let us know how we can assist you in your journey.
        </p>
